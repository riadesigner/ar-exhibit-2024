 ...
 * --------------------------------------------------------------------------------
 * Получает на вход:
 * 1. ar-маркер (THREE_GROUP объект с выставленным положением в пространстве)
 * 2. количество кадров (TF, TOTAL_FRAMES) в анимации, которой нужно управлять
 *   (default=360)
 * 3. количество оборотов маркера (TR, TOTAL_ROUNDS), 
 ...
 * вернет номер кадра 150/2 = 75,
 * т.к 90 / (360/120) + 360 / (360/120) = 30 + 120 = 150 / 2 = 75
 * ----------------------------------------------------------------------------------------
